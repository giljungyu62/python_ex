...
# 함수를 정의할 때 def 키워드를 사용합니다. 그리고 함수명은 콜론(:), 실행부를 이용합니다.
# '''
# '''
# def 함수명():
#     실행부(함수 기능)
...
# 5. 두개이상의 단어가 조합되는 경우 스네이크 또는 카멜표기법을 사용하자.sendMessage():
#     sendMessage(): calculateDistance():
# '''

# # quiz) 온도센서 작동 시스템 만들기
# # 온도센서를 작동을 시작하고 멈추는 함수를 정의해봅시다.
...
# def sub():
#     print(f'뺼셈 결과: {inputNumber1 - inputNumber2}')
