...
# pop()과 비슷하게 사용랗 수 있는 키워드 del
del sports[1]
print(f'sports: {sports}') #  ['football']

# pop() vs del
nums = [1, 2, 3, 4, 5, 6]
deletedNum = nums.pop(3) # [1, 2, 3, 4, 5, 6]  ㅣ deleted item: 4
