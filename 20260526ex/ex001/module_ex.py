...
print(f'randint(): {random.randrange(0, 9)}') # 0이상 9미만 난수
print(f'randint(): {random.sample(range(0, 10), 3)}') # 0이상 10미만 3개 난수
...
week = ['월요일', '화요일', '수요일', '목요일', '금요일', '토요일', '월요일']
