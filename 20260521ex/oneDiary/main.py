...
while flag:
    ...
    if menuNum == config.SIGN_UP:
        ...
        print('3.modify')
        '''
        id, pw, mail, phone 중에서 어떤 정보들만 수정가능하게 할 것인지 정해야 합니다.
        id: X, 또한 이미 탈퇴한 회원의 ID라도 절대 변경 사용할 수 없습니다.
        pw: 절대 수정이 불가하지는 않습니다. 하지만 쉽게 변경할 수는 없습니다.
        mail: 비교적 단순하게 수정할수 있습니다.
        phone: 비교적 단순하게 수정할수 있습니다.
        '''
        ...
        '''
           ...
           - 지금 현재 memberDB에는 'gildong', 'chango'회원이 있다.
           - 현재 로그인되어 있는 회원 정보를 불러와서 그 정보를 수정합니다.
           - 즉, session.signInedMemberId에서 현재 로그인이 되어 있는 회원 ID를 가져와서
           - 사용하면 된다.
        '''
        ...
        - 메뉴를 변경해야겠다.
        - 로그인 값을 없애야겠다.
        - session 모듈에 signInedMemberId 변수에 있는거죠?
        '''
