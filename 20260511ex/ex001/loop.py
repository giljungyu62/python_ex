...
#     print(f'num: {num}')
# range() 간략화- 단계가 생략되고 시작이 0미면 시작도 생략 가능하다.
...
# # quiz) 사용자가 입력한 횟수만큼 '메일 방송!' 문자열 출력하기
...
# userInputData = int(input('구구단 입력'))
# for dd in range(1, 10):
#     print(f'{userInputData} X {dd} = {userInputData * dd}')
# userInputData = int(input('구구단 입력'))
# for dd in range(10):
#     if dd !=0:
...
# # 그런데 이터러블에는 다음과 같이 문자열을 이용할 수 있습니다.
# # '''
...
# # quiz) 1~30까의 정수 중 홀수와 짝수를 구분하여 출력하기
...
#     str = ''
#     while num2 < 10:
#         str += f'{num2} x {num1} = {num2 * num1}\t' # 2 X 1= 3 3 X 1 = 3 4 X 1 = 4 ... 9 X 1 =9
#         num2 += 1
...
# continue를 이용해서 1부터 10까지의 정수 중 홀수만 출력하는 프로그램 만들어 봅시다.
# for num in range(1,11):
#     if num % 2 == 0:
#         continue
#     print(f'num: {num}')
...
# for ~ else 키워드(별로 안중요함)
# '''
# for문에 else 키워드를 사용하는 경우, else 이하의 구문은 for문의 반복 업무를 모두 완료하고
# 난 후 실행됩니다.
# '''

# # 1부터 5까지 정수를 출력하고 반복문이 끝나면 완료 메시지를 출려하자!
