...
# quiz) 학점 경고 프로그램 만들기
'''
scores는 1학기 성적을 튜플로 나타낸 것입니다. F 학점이 읐으면 '경고'를 출력하는 프로그램을 만들자!
scores = ('A', 'A+', 'B', 'B-', 'F')
'''
scores = ('A', 'A+', 'B', 'B-')
if 'F' in scores:
...
fruits = ('apple', 'banana', 'plum', 'watermelon', 'peach')
print(f'fruits[2:5]: {fruits[2:4]}') # ('plum', 'watermelon', 'peach')
print(f'fruits[0:4]: {fruits[0:3]}') # ('apple', 'banana', 'plum', 'watermelon')
